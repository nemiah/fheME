...
class WetterGUI extends Wetter implements iGUIHTML2 {
	function getHTML($id){
		...
		$gui->descriptionField("WetterWOEID", "Siehe: <a href=\"http://edg3.co.uk/snippets/weather-location-codes/\" target=\"_blank\">http://edg3.co.uk/snippets/weather-location-codes/</a>");
