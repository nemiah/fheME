...
class BrickletRotaryPoti extends Device
{
    ...
    public function __construct($uid)
    {
        ...
        $this->expectedName = 'Rotary Poti Bricklet';
     ...
     * 
     *  BrickletRotaryPoti::CALLBACK_POSITION_REACHED, BrickletRotaryPoti::CALLBACK_ANALOG_VALUE_REACHED
     * 
     * are triggered, if the thresholds
     * 
     *  BrickletRotaryPoti::setPositionCallbackThreshold(), BrickletRotaryPoti::setAnalogValueCallbackThreshold()
     * 
     * keep being reached.
     * 
