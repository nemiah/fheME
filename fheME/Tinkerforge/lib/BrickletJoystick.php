...
class BrickletJoystick extends Device
{
    ...
    public function __construct($uid)
    {
        ...
        $this->expectedName = 'Joystick Bricklet';
    ...
    public function getPosition()
    {
        ...
        $data = $this->sendRequestExpectResponse(self::FUNCTION_GET_POSITION, $payload, 4);
    ...
    public function isPressed()
    {
        ...
        $data = $this->sendRequestExpectResponse(self::FUNCTION_IS_PRESSED, $payload, 1);
    ...
    public function getAnalogValue()
    {
        ...
        $data = $this->sendRequestExpectResponse(self::FUNCTION_GET_ANALOG_VALUE, $payload, 4);
    ...
    public function getPositionCallbackThreshold()
    {
        ...
        $data = $this->sendRequestExpectResponse(self::FUNCTION_GET_POSITION_CALLBACK_THRESHOLD, $payload, 9);
    ...
    public function getAnalogValueCallbackThreshold()
    {
        ...
        $data = $this->sendRequestExpectResponse(self::FUNCTION_GET_ANALOG_VALUE_CALLBACK_THRESHOLD, $payload, 9);
     ...
     * 
     *  BrickletJoystick::CALLBACK_POSITION_REACHED, BrickletJoystick::CALLBACK_ANALOG_VALUE_REACHED
     * 
     * are triggered, if the thresholds
     * 
     *  BrickletJoystick::setPositionCallbackThreshold(), BrickletJoystick::setAnalogValueCallbackThreshold()
     * 
     * keep being reached.
     * 
