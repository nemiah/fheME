...
class BrickletVoltage extends Device
{
    ...
    public function __construct($uid)
    {
        ...
        $this->expectedName = 'Voltage Bricklet';
     ...
     * 
     *  BrickletVoltage::CALLBACK_VOLTAGE_REACHED, BrickletVoltage::CALLBACK_ANALOG_VALUE_REACHED
     * 
     * are triggered, if the thresholds
     * 
     *  BrickletVoltage::setVoltageCallbackThreshold(), BrickletVoltage::setAnalogValueCallbackThreshold()
     * 
     * keep being reached.
     * 
