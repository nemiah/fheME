...
class BrickletCurrent25 extends Device
{
     ...
     * sensor.
     * 
     * BrickletCurrent25::CALLBACK_CURRENT is only triggered if the current has changed since the
     * last triggering.
     */
     ...
     * sensor.
     * 
     * BrickletCurrent25::CALLBACK_ANALOG_VALUE is only triggered if the current has changed since the
     * last triggering.
     */
    ...
    public function __construct($uid)
    {
        ...
        $this->expectedName = 'Current25 Bricklet';
     ...
     * callback BrickletCurrent25::CALLBACK_CURRENT and set the period with 
    ...
    public function getCurrent()
    {
        ...
        $data = $this->sendRequestExpectResponse(self::FUNCTION_GET_CURRENT, $payload, 2);
    ...
    public function calibrate()
    {
        ...
        $this->sendRequestNoResponse(self::FUNCTION_CALIBRATE, $payload);
    }
    ...
    public function isOverCurrent()
    {
        ...
        $data = $this->sendRequestExpectResponse(self::FUNCTION_IS_OVER_CURRENT, $payload, 1);
     ...
     * callback BrickletCurrent25::CALLBACK_ANALOG_VALUE and set the period with 
    ...
    /**
     * Sets the period in ms with which the BrickletCurrent25::CALLBACK_CURRENT callback is triggered
    ...
    public function setCurrentCallbackPeriod($period)
    {
        ...
        $this->sendRequestNoResponse(self::FUNCTION_SET_CURRENT_CALLBACK_PERIOD, $payload);
    }
    ...
    public function getCurrentCallbackPeriod()
    {
        ...
        $data = $this->sendRequestExpectResponse(self::FUNCTION_GET_CURRENT_CALLBACK_PERIOD, $payload, 4);
    ...
    /**
     * Sets the period in ms with which the BrickletCurrent25::CALLBACK_ANALOG_VALUE callback is triggered
     * periodically. A value of 0 turns the callback off.
     * 
     * BrickletCurrent25::CALLBACK_ANALOG_VALUE is only triggered if the analog value has changed since the
     * last triggering.
     * 
     * The default value is 0.
     * 
    ...
    public function setCurrentCallbackThreshold($option, $min, $max)
    {
        ...
        $this->sendRequestNoResponse(self::FUNCTION_SET_CURRENT_CALLBACK_THRESHOLD, $payload);
    }
    ...
    public function getCurrentCallbackThreshold()
    {
        ...
        $data = $this->sendRequestExpectResponse(self::FUNCTION_GET_CURRENT_CALLBACK_THRESHOLD, $payload, 5);
     ...
     * 
     *  BrickletCurrent25::CALLBACK_CURRENT_REACHED, BrickletCurrent25::CALLBACK_ANALOG_VALUE_REACHED
     * 
     * are triggered, if the thresholds
     * 
     *  BrickletCurrent25::setCurrentCallbackThreshold(), BrickletCurrent25::setAnalogValueCallbackThreshold()
     * 
     * keep being reached.
     * 
