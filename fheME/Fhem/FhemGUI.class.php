...
class FhemGUI extends Fhem implements iGUIHTML2 {
	...
	function getHTML($id){
		...
		$gui->type("FhemType", "select", array("" => "none", "FS20" => "FS20","FHZ" => "FHZ", "FHT" => "FHT", "notify" => "notify", "dummy" => "dummy"/*,"RGB" => "RGB"*/));
		...
		$gui->attributes(array("FhemServerID", "FhemLocationID", "FhemName", "FhemInOverview", "FhemType", "FhemModel", "FhemSpecific", "FhemRunOn", "FhemCommand", "FhemFHTModel"/*, "FhemFHTDefaultDayTemp"*/));
		
		$gui->space("FhemType");
		
		$gui->toggleFieldsInit("FhemType", array("FhemModel", "FhemSpecific", "FhemRunOn", "FhemCommand", "FhemFHTModel", "FhemFHTDefaultDayTemp"));
