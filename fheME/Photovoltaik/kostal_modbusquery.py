...
class kostal_modbusquery:
    def __init__(self):
        ...
        self.Adr106=[]
        self.Adr106 =[106]
        self.Adr106.append("Consumption power Home Battery")
        self.Adr106.append("Float")
        self.Adr106.append(0) 
        
        self.Adr108=[]
        self.Adr108 =[108]
        self.Adr108.append("Consumption power Home Grid")
        ...
        self.Adr116=[]
        self.Adr116 =[116]
        self.Adr116.append("Consumption power Home PV")
        ...
        self.Adr200=[]
        self.Adr200 =[200]
        self.Adr200.append("Battery current")
        ...
        self.Adr260=[]
        self.Adr260 =[260]
        self.Adr260.append("DC1 power Panels generated")
        ...
        self.Adr270=[]
        self.Adr270 =[270]
        self.Adr270.append("DC2 power Panels generated")
        ...
        self.Adr280=[]
        self.Adr280 =[280]
        self.Adr280.append("DC3 power Panels generated")
        ...
        self.Adr514=[]
        self.Adr514 =[514]
        self.Adr514.append("Battery SOC")
        ...
        self.Adr529=[]
        self.Adr529 =[529]
        self.Adr529.append("Work Capacity")
        ...
        self.Adr575=[]
        self.Adr575 =[575]
        self.Adr575.append("Inverter power generated")
    ...
    try:
        def run(self):
            ...
            #self.Adr529[3]=self.ReadU32(self.Adr529[0])
...
if __name__ == "__main__":  
    ...
    #print(json.dumps(Kostalquery.KostalRegister, sort_keys=True, indent=4, separators=(',', ': ')))
    ##########################################
    #print ("----------------------------------")
    ...
    LeftSidePowerGeneration= round((KostalVal['DC1 power Panels generated']+ KostalVal['DC2 power Panels generated']),1)
    ...
    TotalHomeconsumption =round((KostalVal['Consumption power Home Battery'] + KostalVal['Consumption power Home Grid'] + KostalVal['Consumption power Home PV']),1)
    PowertoGrid = round(KostalVal['Inverter power generated'] - TotalHomeconsumption,1)
