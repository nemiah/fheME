...
class ISO3166 {
	...
	public static function getCountries($lang = null, $length = 2){
		if($lang === null)
		...
		switch($lang){
			...
			case "es":
				return self::getCountriesES($length);
			break;
	...
	public static function getCountriesES(){
		$codes = '"Afganistán","AF","AFG"
"Albania","AL","ALB"
"Alemania","DE","DEU"
"Andorra","AD","AND"
"Angola","AO","AGO"
...
"Eslovenia","SI","SVN"
"España","ES","ESP"
"Estados Unidos de América","US","USA"
"Estonia","EE","EST"
"Etiopía","ET","ETH"
"Filipinas","PH","PHL"
"Finlandia","FI","FIN"
...
"República de Sudán del Sur","SS","SSD"
"Reunión","RE","REU"
"Ruanda","RW","RWA"
"Rumanía","RO","ROU"
"Rusia","RU","RUS"
...
"San Bartolomé","BL","BLM"
"San Cristóbal y Nieves","KN","KNA"
"San Marino","SM","SMR"
"San Martín (Francia)","MF","MAF"
